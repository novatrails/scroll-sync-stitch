    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/destinations" className="text-emerald-300 font-semibold">Destinations</Link>
      ...
      <section className="h-screen relative overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2560&q=100')`
          }}
        />
        ...
        <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          <div className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-3xl leading-relaxed animate-fade-in">
              From the heights of Mount Kilimanjaro to the pristine beaches of Zanzibar, discover Tanzania's most incredible destinations with expert local guides.
            </p>
            <Button 
              onClick={() => setBookingModalOpen(true)}
